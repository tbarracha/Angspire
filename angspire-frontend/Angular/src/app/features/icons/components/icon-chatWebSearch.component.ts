// icon-chatWebSearch.component.ts
...
export class IconChatWebSearchComponent {
  ...
  get svg() { return Icons.chatWebSearch.svg; }
  get src() { return Icons.chatWebSearch.url; }
}
