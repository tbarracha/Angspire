// icon-thumbsDownFilled.component.ts
...
@Component({
  selector: 'icon-thumbsDownFilled',
  standalone: true,
...
export class IconThumbsDownFilledComponent {
  ...
  get svg() { return Icons.thumbsDownFilled.svg; }
  get src() { return Icons.thumbsDownFilled.url; }
}
