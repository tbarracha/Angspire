// icon-sidebarRightPointLeft.component.ts
...
@Component({
  selector: 'icon-sidebarRightPointLeft',
  standalone: true,
...
export class IconSidebarRightPointLeftComponent {
  ...
  get svg() { return Icons.sidebarRightPointLeft.svg; }
  get src() { return Icons.sidebarRightPointLeft.url; }
}
