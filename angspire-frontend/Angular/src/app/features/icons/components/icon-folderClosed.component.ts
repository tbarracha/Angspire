// icon-folderClosed.component.ts
...
export class IconFolderClosedComponent {
  ...
  get svg() { return Icons.folderClosed.svg; }
  get src() { return Icons.folderClosed.url; }
}
