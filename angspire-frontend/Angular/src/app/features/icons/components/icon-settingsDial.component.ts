// icon-settingsDial.component.ts
...
export class IconSettingsDialComponent {
  ...
  get svg() { return Icons.settingsDial.svg; }
  get src() { return Icons.settingsDial.url; }
}
