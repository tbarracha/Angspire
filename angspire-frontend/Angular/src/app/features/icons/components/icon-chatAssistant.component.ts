// icon-chatAssistant.component.ts
...
export class IconChatAssistantComponent {
  ...
  get svg() { return Icons.chatAssistant.svg; }
  get src() { return Icons.chatAssistant.url; }
}
