// icon-thumbsUpFilled.component.ts
...
export class IconThumbsUpFilledComponent {
  ...
  get svg() { return Icons.thumbsUpFilled.svg; }
  get src() { return Icons.thumbsUpFilled.url; }
}
