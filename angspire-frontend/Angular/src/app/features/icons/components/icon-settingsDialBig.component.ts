// icon-settingsDialBig.component.ts
...
export class IconSettingsDialBigComponent {
  ...
  get svg() { return Icons.settingsDialBig.svg; }
  get src() { return Icons.settingsDialBig.url; }
}
