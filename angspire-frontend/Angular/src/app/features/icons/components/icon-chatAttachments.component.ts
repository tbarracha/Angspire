// icon-chatAttachments.component.ts
...
export class IconChatAttachmentsComponent {
  ...
  get svg() { return Icons.chatAttachments.svg; }
  get src() { return Icons.chatAttachments.url; }
}
