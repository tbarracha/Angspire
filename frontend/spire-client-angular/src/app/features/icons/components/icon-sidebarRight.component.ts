// icon-sidebarRight.component.ts
...
export class IconSidebarRightComponent {
  ...
  get svg() { return Icons.sidebarRight.svg; }
  get src() { return Icons.sidebarRight.url; }
}
