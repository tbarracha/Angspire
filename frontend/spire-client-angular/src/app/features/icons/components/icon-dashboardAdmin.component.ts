// icon-dashboardAdmin.component.ts
...
export class IconDashboardAdminComponent {
  ...
  get svg() { return Icons.dashboardAdmin.svg; }
  get src() { return Icons.dashboardAdmin.url; }
}
