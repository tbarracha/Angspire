// icon-genspireLogo.component.ts
...
export class IconGenspireLogoComponent {
  ...
  get svg() { return Icons.genspireLogo.svg; }
  get src() { return Icons.genspireLogo.url; }
}
