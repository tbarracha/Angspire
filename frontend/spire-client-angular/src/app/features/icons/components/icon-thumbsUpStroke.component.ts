// icon-thumbsUpStroke.component.ts
...
export class IconThumbsUpStrokeComponent {
  ...
  get svg() { return Icons.thumbsUpStroke.svg; }
  get src() { return Icons.thumbsUpStroke.url; }
}
