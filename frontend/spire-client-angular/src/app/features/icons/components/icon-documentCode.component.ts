// icon-documentCode.component.ts
...
export class IconDocumentCodeComponent {
  ...
  get svg() { return Icons.documentCode.svg; }
  get src() { return Icons.documentCode.url; }
}
