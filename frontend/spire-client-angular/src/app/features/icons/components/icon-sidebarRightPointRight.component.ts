// icon-sidebarRightPointRight.component.ts
...
@Component({
  selector: 'icon-sidebarRightPointRight',
  standalone: true,
...
export class IconSidebarRightPointRightComponent {
  ...
  get svg() { return Icons.sidebarRightPointRight.svg; }
  get src() { return Icons.sidebarRightPointRight.url; }
}
