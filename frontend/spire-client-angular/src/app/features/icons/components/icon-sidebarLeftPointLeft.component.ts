// icon-sidebarLeftPointLeft.component.ts
...
@Component({
  selector: 'icon-sidebarLeftPointLeft',
  standalone: true,
...
export class IconSidebarLeftPointLeftComponent {
  ...
  get svg() { return Icons.sidebarLeftPointLeft.svg; }
  get src() { return Icons.sidebarLeftPointLeft.url; }
}
