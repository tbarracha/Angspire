// icon-thumbsDownStroke.component.ts
...
@Component({
  selector: 'icon-thumbsDownStroke',
  standalone: true,
...
export class IconThumbsDownStrokeComponent {
  ...
  get svg() { return Icons.thumbsDownStroke.svg; }
  get src() { return Icons.thumbsDownStroke.url; }
}
