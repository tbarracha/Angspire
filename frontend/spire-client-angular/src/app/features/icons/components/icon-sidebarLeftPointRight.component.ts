// icon-sidebarLeftPointRight.component.ts
...
@Component({
  selector: 'icon-sidebarLeftPointRight',
  standalone: true,
...
export class IconSidebarLeftPointRightComponent {
  ...
  get svg() { return Icons.sidebarLeftPointRight.svg; }
  get src() { return Icons.sidebarLeftPointRight.url; }
}
