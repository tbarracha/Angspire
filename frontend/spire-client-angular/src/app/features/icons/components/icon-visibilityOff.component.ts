// icon-visibilityOff.component.ts
...
export class IconVisibilityOffComponent {
  ...
  get svg() { return Icons.visibilityOff.svg; }
  get src() { return Icons.visibilityOff.url; }
}
